Essential.Diagnostics.EmailTraceListener
========================================
...
Email trace listener extension for System.Diagnostics, 
along with required config sections. Sends each trace message 
received in an email, using the specified subject and body 
templates. Note: Set a filter to avoid flooding (don't rely 
on trace source switch value).
