Essential.Diagnostics with Configuration
========================================
...
This package contains configuration examples for the additional 
trace listeners from the Essential.Diagnostics project.
...
It includes (as a dependency) the main Essential.Diagnostics package,
which contains extensions to the .NET Framework 
